...
void Multiwin::sortByPageRankButtonClicked(){
  ...
  // std::cout << std::endl << "pagerank map: " << std::endl;
  // std::map<WebPage*, double>::iterator it5;
  // for(it5 = mapPageRankOf.begin(); it5 != mapPageRankOf.end(); ++it5){// print out page ranks after computation
  //   std::cout << "webpage: " << it5->first->filename() << " , pagerank: " << it5->second << std::endl;
  // }
  // std::cout << "**********************************************************" << std::endl ;
  ...
  while(i <= t){
    ...
    for(it = mapPageRankOf.begin(); it != mapPageRankOf.end(); ++it){//update P() of each webpage
      ...
      for(u = inSet.begin(); u != inSet.end(); ++u){//SUM of pageranks of incoming pages/their out_degree 
         // if(*u == (it->first)){// calculating self loop
         //    std::cout << " *******" << std::endl;
         // }
    ...
    // std::cout << std::endl << "pagerank map: " << i << std::endl;
    std::map<WebPage*, double>::iterator it5;
    double PGSumTest = 0;
    for(it5 = mapPageRankOf.begin(); it5 != mapPageRankOf.end(); ++it5){// print out page ranks after computation
      // std::cout << "webpage: " << (it5->first)->filename() << " , pagerank: " << it5->second << std::endl;
      PGSumTest += it5->second;
    }
    // std::cout << "Total PageRank: " << PGSumTest << std::endl;
    // std::cout << "**********************************************************" << std::endl ;

    i++;
  }

  // std::map<WebPage*, double>::iterator it3;
  // double PGSum = 0;
  // std::cout << std::endl << "Map after full calc: " << std::endl;
  // for(it3 = mapPageRankOf.begin(); it3 != mapPageRankOf.end(); ++it3){// print out page ranks after computation
  //   std::cout << "webpage: " << it3->first->filename() << " , pagerank: " << it3->second << std::endl;
  //   PGSum += it3->second;
  // } 
  // std::cout << "Total PageRank(should be 1): " << PGSum << std::endl;
  // std::cout << std::endl;  
  ...
  // std::cout << "vector of pages from map to ranks: " << std::endl;
  // for(unsigned int j = 0; j < vectPageRank.size(); j++){//print vector out for testing
  //  std::cout << (vectPageRank[j].first)->filename() << std::endl;
  // }
